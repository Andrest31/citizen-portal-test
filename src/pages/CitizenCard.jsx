...
function CitizenCard({ citizens }) {
  ...
  const renderPersonalTab = () => (
    <div>
      ...
      <label>
        ...
        <input
          type="text"
          value={citizenData.passport?.series || ""}
          onChange={(e) => handleNestedChange(e, "passport", "series")}
          disabled={!isEditing}
        />
      </label>
      <br />
      <label>
        ...
        <input
          type="text"
          value={citizenData.passport?.number || ""}
          onChange={(e) => handleNestedChange(e, "passport", "number")}
          disabled={!isEditing}
        />
      </label>
      <br />
      <label>
        ...
        <input
          type="text"
          value={citizenData.passport?.issuedBy || ""}
          onChange={(e) => handleNestedChange(e, "passport", "issuedBy")}
          disabled={!isEditing}
        />
      </label>
      <br />
      <label>
        ...
        <input
          type="date"
          value={citizenData.passport?.issueDate || ""}
          onChange={(e) => handleNestedChange(e, "passport", "issueDate")}
          disabled={!isEditing}
        />
      </label>
      <br />
      ...
      <label>
        ...
        <select
          name="maritalStatus"
          value={citizenData.maritalStatus || "холост"}
          onChange={handleInputChange}
          disabled={!isEditing}
        >
          <option>женат</option>
      ...
      <label>
        ...
        <select
          name="educationLevel"
          value={citizenData.educationLevel || "среднее"}
          onChange={handleInputChange}
          disabled={!isEditing}
        >
      ...
      <label>
        ...
        <input
          type="number"
          name="pensionAmount"
          value={citizenData.pensionAmount || 0}
          onChange={handleInputChange}
          disabled={!isEditing}
        />
      </label>
      ...
      <label>
        ...
        <input
          ...
          value={citizenData.disabilityGroup || ""}
          onChange={handleInputChange}
          disabled={!isEditing}
        />
      </label>
      ...
      <label>
        ...
        <input
          ...
          value={citizenData.citizenshipStatus || "Гражданин"}
          onChange={handleInputChange}
          disabled={!isEditing}
        />
      </label>
            ...
            <tr key={index}>
              ...
              <td>
                <input
                  ...
                  value={member.snils}
                  onChange={(e) =>
                    handleFamilyChange(index, "snils", e.target.value)
                  }
                  disabled={!isEditing}
                />
              </td>
      ...
      <ul>
        {citizenData.education.map((edu, index) => (
          <li key={index}>
            ...
            <input
              type="text"
              value={edu.diplomaNum}
              onChange={(e) =>
                handleEducationChange(index, "diplomaNum", e.target.value)
              }
              disabled={!isEditing}
            />
          </li>
  ...
  const renderWorkTab = () => (
    <div>
      ...
      <p>
        ...
        <input
          type="text"
          value={citizenData.work.currentJob}
          onChange={(e) => handleNestedChange(e, "work", "currentJob")}
          disabled={!isEditing}
        />
      </p>
      <p>
        ...
        <input
          type="text"
          value={citizenData.work.position}
          onChange={(e) => handleNestedChange(e, "work", "position")}
          disabled={!isEditing}
        />
      </p>
      <p>
        ...
        <input
          type="date"
          value={citizenData.work.startDate}
          onChange={(e) => handleNestedChange(e, "work", "startDate")}
          disabled={!isEditing}
        />
      </p>
    </div>
  ...
  const saveChanges = () => {
    if (!citizenData.fullName || !citizenData.birthDate) {
  ...
  return (
    <div className="citizen-card" style={{ padding: "20px" }}>
      <h1>Карточка гражданина: {citizenData.fullName}</h1>
      <img
        src={citizenData.photo || "https://via.placeholder.com/100"}
        alt="Фото"
